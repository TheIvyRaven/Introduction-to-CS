...
An iterative method which returns the minimum value in an integer array.
In this method, you must use either a for or a while loop. You should call this method
minArrayIter and it should have a definition as follows: public static int minArrayIter(int[] a)
where a is the input array.
A recursive method which returns the minimum value in an integer array.
You should call this method minArrayRec. The definition of the method should be declared as follows:
public static int minArrayRec(int[] a, int start) where a is the input array.
...
public class MinimumValue
{
    public static void main(String [] args)
    {
        ...
        sc.close();
        System.out.println(minArrayIter(m) + " "+ minArrayRec(m,0));
    }
